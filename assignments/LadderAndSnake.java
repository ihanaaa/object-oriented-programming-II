...
/**
 * Date: February 7th 2022 This is the ladder and snake class which will have
 * methods that will allow players to move on the game board and start the game.
 * 
...
public class LadderAndSnake {
	...
	/**
	 * Ladder array declared to store the int for the bottom and top placements of
	 * the ladders on the board
	 */
	Ladders[] Ladder;
	/**
	 * snake array declared to store the int for the head and the tail placements of
	 * the snakes on the board
	 */
	Snakes[] snake;
	/**
	 * allPlayers array created in order to make the change in position when the
	...
	/**
	 * constructor for LadderAndSnake class which also prompts and sets the player
	 * names in the array of players
	 * 
	...
	/**
	 * method that adds into an array all the bottom and top cases that touch the
	 * ladders and changes the position of the player accordingly.
	 */
	public void ladder() {
	...
	/**
	 * method that adds into an array all the head and tail cases that touch the
	 * snakes and changes the position of the player accordingly.
	 */
	public void snake() {
	...
	/**
	 * methods that sets the order of play according to the order of the biggest
	 * dice value obtained by each player.
	 * 
	...
	/**
	 * method that updates the player on their new positions after every dice flip
	 * until a player arrives at case 100.
	 */
	public void move() {
		setallPlayersArray();
